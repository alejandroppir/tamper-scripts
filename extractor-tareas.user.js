...
(function () {
  ...
  function inicializarScript() {
    ...
    GestorUI.configurarArrastre(panel, document.getElementById('tm-ext-header'), CONFIG.PANEL_POS_KEY, false, {
      top: '20px',
      right: '20px',
      bottom: 'auto',
      left: 'auto',
    ...
    document.getElementById('tm-ext-close').addEventListener('click', () => {
